...
- **Status:** `milestone-reached` — every box on the roadmap is checked. Patches 1–17 sit on `mango/patches-1.10`, the adopted consumer base (and on `mango/patches-1.12`); the next work here is consumer-driven (a new incident, or a retarget onto the next upstream tag).
- **Updated:** 2026-09-17
...
- **Build:** green · **Tests:** green — **358 tests, ZERO failures** on this branch (2026-09-17, full suite, Swift 6.4 / Xcode 27 toolchain) · **Simulator-verified:** n/a
